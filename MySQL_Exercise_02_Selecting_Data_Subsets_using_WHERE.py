...
get_ipython().run_cell_magic('sql', '', 'SELECT user_guid, membership_type\nFROM users\nWHERE membership_type=2;')
...
get_ipython().run_cell_magic('sql', '', 'SELECT user_guid, gender, breed\nFROM dogs\nWHERE gender = \'female\' AND breed LIKE "%terrier%"')
...
get_ipython().run_cell_magic('sql', '', "SELECT dog_guid, test_name, subcategory_name\nFROM complete_tests\nWHERE YEAR(created_at)='2014' AND MONTH(created_at)='10'\nLIMIT 100")
