...
get_ipython().magic('sql Show columns FROM dognitiondb.dogs')
...
get_ipython().run_cell_magic('sql', '', 'SELECT dog_fixed, dna_tested, created_at\nFROM dogs LIMIT 4,12;')
...
get_ipython().run_cell_magic('sql', '', 'SELECT median_iti_minutes / 60\nFROM dogs LIMIT 6,15;')
